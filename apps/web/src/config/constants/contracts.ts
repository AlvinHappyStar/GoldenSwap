...
export default {
  masterChef: {
    [ChainId.ETHEREUM]: '0xB2b1a37742aacfC90d06bDFe9B7A35f8826597dc',
  ...
  masterChefV1: {
    [ChainId.ETHEREUM]: '0xbD17B1ce622d73bD438b9E658acA5996dc394b0d',
  ...
  stableSwapNativeHelper: {
    ...
    [ChainId.BSC_TESTNET]: '0x494B692Fe0CF54f633dCDFbba0D0a8629Edb344F',
  },
  iCake: {
  ...
  nonBscVault: {
    [ChainId.BSC]: '0x8024c5299c301fbB87d2e6Df6f4F6bdF7B80B9C8', // Only for pass contracts test
